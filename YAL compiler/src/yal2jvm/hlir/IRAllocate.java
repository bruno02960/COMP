...
public class IRAllocate extends IRNode
{
	...
	/**
	 * Constructor for cases when we have a lhs variable, previously allocated or
	 * not, and an integer or a variable on rhs. Cases like a=1 or a=b.
	 * 
	 * @param name
	 *            of the lhs variable
	 * @param value
	 *            of the rhs, constant or variable
	 */
	...
	/**
	 * Constructor for cases when we have a lhs variable, previously allocated or
	 * not, and an integer or a variable on rhs indicating array size. Cases like a
	 * = [5].
	 * 
	 * @param name
	 *            the lhs variable
	 ...
	 *            the array size
	 * @param arraySize
	 *            indicate Type.ARRAYSIZE, It's mandatory
	 */
	...
	/**
	 * Constructor for cases when we have a lhs variable array, previously
	 * allocated, and set an element of the array. The element set is at an index,
	 * as is set with an integer or a variable on rhs. Cases like a[i] = 5.
	 * 
	 * @param name
	 *            the lhs variable, an array at a given index
	 * @param value
	 *            the rhs value
	 */
	...
	/**
	 * Constructor for cases when we have a lhs variable integer, previously
	 * allocated or not, and set its value with an array element. The element is at
	 * an index, as it's value is set to the lhs variable. Cases like a = b[5].
	 * 
	 * @param name
	 *            the lhs variable
	 * @param value
	 *            the rhs value, an array at a given index
	 */
	...
	/**
	 * Constructor for cases when we have a lhs variable array, previously
	 * allocated, and set an element of the array. The element is at an index, as
	 * it's value is set to the lhs variable at another index because rhs is also an
	 * array. Cases like a[i] = b[5].
	 * 
	 * @param name
	 *            the lhs variable, an array at a given index
	 * @param value
	 *            the rhs variable, an array at a given index
	 */
	...
	private void handleConstantRhsForConstantPropagationOptimisation()
	{
		...
		// do nothing if variable type is array and we are setting all its position to
		// the value in rhs
