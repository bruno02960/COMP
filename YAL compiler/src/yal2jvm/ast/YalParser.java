...
public class YalParser/*@bgen(jjtree)*/implements YalParserTreeConstants, YalParserConstants {/*@bgen(jjtree)*/
  protected static JJTYalParserState jjtree = new JJTYalParserState();public static void main(String args []) throws ParseException, IOException
  {
...
/*While ::= <WHILE> Exprtest <LCHAVETA> Stmtlst <RCHAVETA> */
 ...
 /*@bgen(jjtree) WHILE */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Token L_Chaveta = null;
    try {
      try {
...
/*If ::= <IF> Exprtest <LCHAVETA> Stmtlst <RCHAVETA> ( <ELSE> <LCHAVETA> Stmtlst <RCHAVETA> )? */
 ...
 /*@bgen(jjtree) IF */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Token L_Chaveta_IF = null;
